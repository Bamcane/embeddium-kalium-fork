...
public final class GLDebug {
    static final Logger LOGGER = LogManager.getLogger("Embeddium/GLDebug");
	...
	public static void reloadDebugState() {
		if (Boolean.getBoolean("kalium.enableGLDebug") && (GL.getCapabilities().GL_KHR_debug || GL.getCapabilities().OpenGL43)) {
